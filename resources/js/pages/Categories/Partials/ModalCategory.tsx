...
export const ModalEditCategory = ({ category }: { category: Category }) => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogTitle>Ubah kategori {category.name}?</DialogTitle>
                <DialogDescription>
                    Mengubah kategori ini akan memperbarui semua postingan terkait.
                </DialogDescription>
...
export const ModalDeleteCategory = ({ category }: { category: Category }) => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogTitle>Apakah anda ingin mengapus {category.name}?</DialogTitle>
                <DialogDescription>
                    Perhatian menghapus kategori menyebabkan data postingan blog juga ikut terhapus
                </DialogDescription>
